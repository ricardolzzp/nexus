sap.ui.define([
    ...
    const constants = {
        ...
        currentRoute: "RouteProdutosCreate",
        previousRoute: "RouteProdutos",
        entity: "/Products",
        form: "AdminObjectPageLayoutProdutos"
    }

    return BaseController.extend("nebula.controller.Produtos.Create", { 
        onInit() {
