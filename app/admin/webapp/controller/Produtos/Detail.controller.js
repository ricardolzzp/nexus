sap.ui.define(["../BaseController",
    ...
    const constants = {
        parentRoute: "RouteProdutos",
        currentRoute: "RouteProdutosDetail",
        createRoute: "RouteProdutosCreate",
        detailRoute: "RouteProdutosDetail",
        form: "AdminObjectPageLayoutProdutosDetail",
        entity: '/Products'
    }
        
    return BaseController.extend("admin.controller.Produtos.Detail", { 
        formatter: formatter,
        ...
        onHandleSavePressed: async function(oEvent) {
            ...
            await ModelHelper.update(oModel, `${entity}(${this.data.ID})`, oData, Messaging )
